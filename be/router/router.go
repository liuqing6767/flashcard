...
import (
	...
	"github.com/liuximu/flashcard/be/controller/auth"
	"github.com/liuximu/flashcard/be/controller/card"
	"github.com/liuximu/flashcard/be/controller/knows"
	"github.com/liuximu/flashcard/be/controller/template"
...
func Route(e *echo.Echo) {
	...
	cardGroup.GET("/ext", shared.Mine2Handler(card.UpsertExt))
